...
<div class="wrapper">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="#" class="dropdown-item">
            <i class="fas fa-envelope mr-2"></i> 1 [nombre empresa]
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('admin.index') }}" class="brand-link text-center">
      <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="120" version="1.1" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd; opacity:. 8"
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item text-danger">
                <a href="#" class="btn btn-block btn-primary"><i class="fas fa-exclamation-triangle"></i> Reportar error</a>
              </li>
            </ol>
          </div>
        </div>
  ...
  <footer class="main-footer">
    ...
    <strong><a href="https://www.runs.com.ar" target="_blank">Runs</a></strong>
  </footer>
...
<!-- Bootstrap 4 -->
<script src="{{ asset('storage/styles_S/js/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
<!-- AdminLTE App -->
